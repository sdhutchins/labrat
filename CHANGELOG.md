...
- MyGene gene queries with species filtering and build provenance
- MyVariant rsID and hg19 genomic HGVS queries with source-version provenance
- PubTator 3 free-text, semantic entity, and relation literature searches
- Rich terminal presentation and JSON output for biological query commands
- Detailed highest-ranked MyGene results with optional alternative matches
